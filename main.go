...
import (
	...
	service2 "github.com/zhao-annan/route/domain/service"
	"github.com/zhao-annan/route/handler"
	route "github.com/zhao-annan/route/proto/route"
	"k8s.io/client-go/kubernetes"
	"k8s.io/client-go/tools/clientcmd"
	"k8s.io/client-go/util/homedir"
	//hystrix2 "git.imooc.com/zhao-annan/route/plugin/hystrix"
	"strconv"
)
